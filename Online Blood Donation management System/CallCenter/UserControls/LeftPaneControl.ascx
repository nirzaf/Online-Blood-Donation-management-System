    ...
    <tr>
        <td valign="top" >
            <table border="1" >
                ...
                <tr>
                    <td style="background-color: #ff6666; width: 231px;">
                     <asp:Menu ID="Menu3" runat="server" BackColor="#F7F6F3" CssClass="Menu" Font-Bold="True"
                            ForeColor="#7C6F57" Width="122px" Font-Names="Verdana" Font-Size="10pt" DynamicHorizontalOffset="2" StaticSubMenuIndent="10px">
                            <DynamicMenuItemStyle ForeColor="#FF8080" HorizontalPadding="5px" VerticalPadding="2px" />
                            <Items>
                                <asp:MenuItem NavigateUrl="~/Admin/Search.aspx" Text="Search" Value="Home">
                                    <asp:MenuItem NavigateUrl="~/Admin/Search/SearchBloodDonor.aspx" Text="Blood Donor"
                                        Value="Blood Donor"></asp:MenuItem>
                                    <asp:MenuItem NavigateUrl="~/Admin/Search/ShowBloodRequest.aspx" Text="Blood Request"
                                        Value="Blood Request"></asp:MenuItem>
                                </asp:MenuItem>
                            </Items>
                            <StaticMenuItemStyle HorizontalPadding="5px" VerticalPadding="2px" />
                            <DynamicHoverStyle BackColor="#7C6F57" ForeColor="White" />
