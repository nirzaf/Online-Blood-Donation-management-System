<%@ Page Language="C#" MasterPageFile="~/Donor/DonorMasterPage.master" AutoEventWireup="true" CodeFile="MakeRequestForBlood.aspx.cs" Inherits="MakeRequestForBlood" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtBloodType" runat="server" ReadOnly="True"></asp:TextBox>&nbsp;</td>
        </tr>
        <tr>
            <td align="left">
            Blood Group:
            ...
            <td align="left">
                <asp:TextBox ID="txtBloodGroup" runat="server" ReadOnly="True"></asp:TextBox>&nbsp;</td>
        </tr>
        <tr>
            <td align="left">
                Request Date:</td>
